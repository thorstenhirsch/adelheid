...
class ApiKeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_key" do
    assert_difference('ApiKey.count') do
      post api_keys_url, params: { api_key: { active: @api_key.active, key: @api_key.key, name: @api_key.name, user_id: @api_key.user_id } }
    end
  ...
  test "should update api_key" do
    patch api_key_url(@api_key), params: { api_key: { active: @api_key.active, key: @api_key.key, name: @api_key.name, user_id: @api_key.user_id } }
