...
class ConfigurationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create configuration" do
    assert_difference('Configuration.count') do
      post configurations_url, params: { configuration: { authentication_type: @configuration.authentication_type, create_artefacts_on_the_fly: @configuration.create_artefacts_on_the_fly, http_password_digest: @configuration.http_password_digest, http_user: @configuration.http_user, use_authentication: @configuration.use_authentication } }
    end
  ...
  test "should update configuration" do
    patch configuration_url(@configuration), params: { configuration: { authentication_type: @configuration.authentication_type, create_artefacts_on_the_fly: @configuration.create_artefacts_on_the_fly, http_password_digest: @configuration.http_password_digest, http_user: @configuration.http_user, use_authentication: @configuration.use_authentication } }
