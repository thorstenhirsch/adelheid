...
class DeploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deployment" do
    assert_difference('Deployment.count') do
      post deployments_url, params: { deployment: { notes: @deployment.notes, timestamp: @deployment.timestamp } }
    end
  ...
  test "should update deployment" do
    patch deployment_url(@deployment), params: { deployment: { notes: @deployment.notes, timestamp: @deployment.timestamp } }
